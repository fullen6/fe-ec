# com.ingeint.fe-ec-pr

## Standard

- New callout
    * Name: CName
    * Package: ec.ingeint.erp.callout
    * Example: ec.ingeint.erp.callout.CStringFormat

- New process
    * Name: PName
    * Package: ec.ingeint.erp.process
    * Example: ec.ingeint.erp.process.PGenerateWithholding

- New form
    * Name: FName
    * Package: ec.ingeint.erp.form
    * Example: ec.ingeint.erp.form.FMultiPayment

- New event
    * Name: EName
    * Package: ec.ingeint.erp.event
    * Example: ec.ingeint.erp.event.EAfterCompleteInvoice

- New model (extends class X)
    * Name: MName
    * Package: ec.ingeint.erp.model
    * Example: ec.ingeint.erp.model.MTableExample
...
- New callout
    * Create callout in package `ec.ingeint.erp.callout`, extends from `CustomCallout`
    * Register callout in `ec.ingeint.erp.component.CalloutFactory`. Example:
...
- New process
    * Create process in package `ec.ingeint.erp.process`, extends from `CustomProcess`
    * Register process in `ec.ingeint.erp.component.ProcessFactory`. Example:
...
- New form
    * Create form in package `ec.ingeint.erp.form`, extends from `CustomForm`
    * Register form in `ec.ingeint.erp.component.FormFactory`. Example:
...
- New event
    * Create event in package `ec.ingeint.erp.event`, extends from `CustomEvent`
    * Register event in `ec.ingeint.erp.component.EventFactory`. Example:
...
- New model (extends form class X)
    * Create model in package `ec.ingeint.erp.model`, extends class `X`. Example: `X_TL_TableExample -> MTableExample`
    * Register model in `ec.ingeint.erp.component.ModelFactory`. Example:
